...
/// <summary>Validates ApprovalRequestStepCommand before processing input.</summary>
public sealed class ApprovalRequestStepCommandValidator : AbstractValidator<ApprovalRequestStepCommand>
{
    public ApprovalRequestStepCommandValidator()
    {
        ...
        RuleForEach(value => value.Assignees)
            ...
            .NotNull()
            .SetValidator(new ApprovalRequestAssigneeCommandValidator());
    }
}
