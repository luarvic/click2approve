...
/// <summary>Validates ApprovalRequestTaskListQueryCommand before processing input.</summary>
public sealed class ApprovalRequestTaskListQueryCommandValidator : AbstractValidator<ApprovalRequestTaskListQueryCommand>
{
    public ApprovalRequestTaskListQueryCommandValidator()
    {
