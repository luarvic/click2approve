...
/// <summary>Validates SubmitApprovalRequestCommand before processing input.</summary>
public sealed class SubmitApprovalRequestCommandValidator : AbstractValidator<SubmitApprovalRequestCommand>
{
