...
/// <summary>Validates DeleteInAppNotificationsCommand before processing input.</summary>
public sealed class DeleteInAppNotificationsCommandValidator : AbstractValidator<DeleteInAppNotificationsCommand>
{
    public DeleteInAppNotificationsCommandValidator()
    {
