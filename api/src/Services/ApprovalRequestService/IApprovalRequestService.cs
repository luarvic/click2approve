...
public interface IApprovalRequestService
{
    ...
    Task<List<ApprovalRequest>> ListIncomingAsync(AppUser user, ApprovalRequestStatus[] statuses, CancellationToken cancellationToken);
    Task<List<ApprovalRequest>> ListOutgoingAsync(AppUser user, CancellationToken cancellationToken);
    Task<long> CountIncomingAsync(AppUser user, ApprovalRequestStatus[] statuses, CancellationToken cancellationToken);
}
