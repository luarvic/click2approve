...
internal static class ApprovalRequestResponseMapper
{
    ...
    public static ApprovalRequestDetailsResponse Map(ApprovalRequestDetailsResult result) => new()
    {
        ...
        RequesterEmployeeGlobalId = result.RequesterEmployeeGlobalId,
        RequesterUserGlobalId = result.RequesterUserGlobalId,
        SubmittedByUserGlobalId = result.SubmittedByUserGlobalId,
        SubmittedByEmployeeGlobalId = result.SubmittedByEmployeeGlobalId,
        SubmittedByDisplayName = result.SubmittedByDisplayName,
        SubmittedByEmail = result.SubmittedByEmail,
