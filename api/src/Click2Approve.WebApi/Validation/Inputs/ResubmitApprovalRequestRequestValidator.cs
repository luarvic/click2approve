...
/// <summary>Validates ResubmitApprovalRequestRequest before processing input.</summary>
public sealed class ResubmitApprovalRequestRequestValidator : AbstractValidator<ResubmitApprovalRequestRequest>
{
    public ResubmitApprovalRequestRequestValidator()
    {
