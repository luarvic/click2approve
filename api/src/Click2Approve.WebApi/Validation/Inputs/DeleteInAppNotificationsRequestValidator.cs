...
/// <summary>Validates DeleteInAppNotificationsRequest before processing input.</summary>
public sealed class DeleteInAppNotificationsRequestValidator : AbstractValidator<DeleteInAppNotificationsRequest>
{
    public DeleteInAppNotificationsRequestValidator()
    {
