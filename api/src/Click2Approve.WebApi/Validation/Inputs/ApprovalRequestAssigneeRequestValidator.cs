...
/// <summary>Validates ApprovalRequestAssigneeRequest before processing input.</summary>
public sealed class ApprovalRequestAssigneeRequestValidator : AbstractValidator<ApprovalRequestAssigneeRequest>
{
    public ApprovalRequestAssigneeRequestValidator()
    {
