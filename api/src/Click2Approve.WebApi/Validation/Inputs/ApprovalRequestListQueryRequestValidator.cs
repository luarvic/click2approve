...
/// <summary>Validates ApprovalRequestListQueryRequest before processing input.</summary>
public sealed class ApprovalRequestListQueryRequestValidator : AbstractValidator<ApprovalRequestListQueryRequest>
{
    public ApprovalRequestListQueryRequestValidator()
    {
