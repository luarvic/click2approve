...
/// <summary>Validates ApprovalRequestTaskClientAuditContextRequest before processing input.</summary>
public sealed class ApprovalRequestTaskClientAuditContextRequestValidator : AbstractValidator<ApprovalRequestTaskClientAuditContextRequest>
{
    public ApprovalRequestTaskClientAuditContextRequestValidator()
    {
