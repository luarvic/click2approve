...
/// <summary>Validates ApprovalRequestTaskListQueryRequest before processing input.</summary>
public sealed class ApprovalRequestTaskListQueryRequestValidator : AbstractValidator<ApprovalRequestTaskListQueryRequest>
{
    public ApprovalRequestTaskListQueryRequestValidator()
    {
        ...
        RuleFor(value => value.SortBy)
            .MaximumLength(FieldLimits.Name)
            .Must(value => value is null || new[] { "createdat" }.Contains(value.ToLowerInvariant()))
