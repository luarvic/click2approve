...
const actionResultLogoSx: SxProps<Theme> = {
  display: "block",
  height: 72,
  width: 72,
};

const actionResultLogoLinkSx: SxProps<Theme> = {
  display: "block",
  mb: 2,
};
  ...
  return (
    <Container component="main" maxWidth={Pages.centeredMessageMaxWidth}>
      <Box sx={Pages.centeredMessageContainerSx}>
        <Box component={RouterLink} to={Routes.defaultPath} aria-label="Click2Approve home" sx={actionResultLogoLinkSx}>
          <Box component="img" src={logoSrc} alt="Click2Approve" sx={actionResultLogoSx} />
        </Box>
